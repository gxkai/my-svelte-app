	...
	plop.setGenerator('custom-component', {
		...
		actions: [
			function(data) {
				...
				type: 'add',
				path: 'stories/{{dashCase fileName}}/{{camelCase fileName}}.scss',
				templateFile: 'templates/component/index.scss'
			},
			{
				type: 'add',
				path: 'stories/{{dashCase fileName}}/{{properCase fileName}}.stories.js',
				templateFile: 'templates/component/index.stories.js'
			},
			{
				type: 'add',
				path: 'stories/{{dashCase fileName}}/{{properCase fileName}}.svelte',
				templateFile: 'templates/component/index.svelte'
			}
		]
	});
